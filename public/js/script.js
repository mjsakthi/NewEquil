(function ($) {
  ...
  if (
    $(".banner-thumbs-carousel .fullscreen-carousel").length &&
    $(".banner-thumbs-carousel .thumbs-carousel").length
  ) {
  ...
  function mainSliderTwoHeight() {
    if ($(".banner-thumbs-carousel").length) {
      ...
      $(".banner-thumbs-carousel .fullscreen-carousel .slide-item").css(
        "min-height",
        450
      );
      $(".banner-thumbs-carousel .fullscreen-carousel .slide-item").css(
        "height",
        FullScreenHeight - MainHeaderHeight - 70
      );
    }
  }
